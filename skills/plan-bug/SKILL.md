---
name: plan-bug
description: Backlog の bug の根本原因を調査し、原因調査レポートを書き込んで Ready に遷移させる計画ステップ。/issue-keeper:next-step のディスパッチ、または「issue #N の原因調査をして」で発動。
---

# /issue-keeper:plan-bug — bug: Backlog → Ready
